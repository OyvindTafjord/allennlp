...
@Model.register("bidaf_nospan")
class BidirectionalAttentionFlowNoSpan(Model):
    """
    Same as BidirectionalAttentionFlow but allows for a "no answer" span option to encode
    instances where no answer is found in the passage.
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(BidirectionalAttentionFlowNoSpan, self).__init__(vocab)
        ...
        self._span_full_accuracy = CategoricalAccuracy()
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        return {
                ...
                'span_full_acc': self._span_full_accuracy.get_metric(reset),
