...
class FrictionQDecoderState(DecoderState['FrictionQDecoderState']):
    """
    Parameters
    ----------
    ...
    def __init__(self,
        ...
        super(FrictionQDecoderState, self).__init__(batch_indices, action_history, score)
    ...
    def combine_states(cls, states: List['FrictionQDecoderState']) -> 'FrictionQDecoderState':
        ...
        if states[0].debug_info is not None:
            ...
            debug_info = None
        return FrictionQDecoderState(batch_indices=batch_indices,
