...
class FrictionQDecoderStep(DecoderStep[FrictionQDecoderState]):
    ...
    @overrides
    def take_step(self,
                  state: FrictionQDecoderState,
                  max_actions: int = None,
                  allowed_actions: List[Set[int]] = None) -> List[FrictionQDecoderState]:
    ...
    @staticmethod
    def _get_actions_to_consider(state: FrictionQDecoderState) -> Tuple[List[List[int]],
                                                                         List[List[int]],
                                                                         List[List[int]]]:
        """
        The ``FrictionQDecoderState`` defines a set of actions that are valid in the current
    ...
    @staticmethod
    def _get_action_embeddings(state: FrictionQDecoderState,
        ...
        """
        assert(len(actions_to_embed) == len(state.batch_indices))
    ...
    @staticmethod
    def _compute_new_states(state: FrictionQDecoderState,
                            ...
                            max_actions: int = None) -> List[FrictionQDecoderState]:
