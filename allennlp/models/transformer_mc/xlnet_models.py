...
# Simple span prediction model, similar to XLNetForQuestionAnsweringSimple in Hugging Face code
@Model.register("xlnet_span_prediction")
class XLNetSpanPredictionModel(Model):
    """
    ...
    # Copied from tokenization_xlnet
