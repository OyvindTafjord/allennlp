...
class RuleReasoningReader(DatasetReader):
                ...
                for question in questions:
                    ...
                    if self._syntax == "rulebase":
                        ...
                        if 'label' in question:
                            label_raw = question['label']
                            if isinstance(label_raw, bool):
                                label = 1 if label_raw else 0
                            else:
                                label = ["false", "true", "unknown"].index(label_raw.lower())
                    elif self._syntax == "propositional-meta":
    ...
    def text_to_instance(self,  # type: ignore
        ...
        qa_tokens = self.transformer_features_from_qa(question_text, context)
    ...
    def transformer_features_from_qa(self, question: str, context: str):
        ...
        tokens = self._tokenizer.tokenize_sentence_pair(context, question)
        return tokens